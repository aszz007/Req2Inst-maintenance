...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train the General Expert with full fine-tuning')
    ...
    print(f"  - Max Seq Length: 2048 (covers 85% of General samples)")
    ...
    print("Note: Text 90%, Image 100%, and UML 70% coverage")
