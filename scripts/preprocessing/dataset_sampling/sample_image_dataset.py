...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Randomly sample and display examples from the image dataset (data/dataset/image/image_dataset.csv)"
    )
    parser.add_argument(
        "--n",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Save sampled results to the specified path (optional, e.g. outputs/samples/image_samples.csv)"
    )
    parser.add_argument(
        "--dataset",
        type=str,
        default=None,
        help=f"Dataset CSV path (default: {IMAGE_DATASET_PATH})"
    )
