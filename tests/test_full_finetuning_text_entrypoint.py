"""Focused regression coverage for the text full-finetuning entry point."""
...
def test_text_full_finetuning_main_preserves_config_and_training_order(
    monkeypatch,
    capsys,
):
    events = []
    ...
    class FakeTrainer:
        output_dir = Path("checkpoints/full_finetuning/text_expert")
    ...
    assert "checkpoints\\full_finetuning\\text_expert" in output
